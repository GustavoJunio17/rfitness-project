...
-- CreateIndex
CREATE INDEX "students_gymId_whatsapp_idx" ON "students"("gymId", "whatsapp");
...
-- CreateIndex
CREATE UNIQUE INDEX "suppliers_gymId_name_key" ON "suppliers"("gymId", "name");

-- CreateIndex
CREATE INDEX "products_gymId_status_idx" ON "products"("gymId", "status");
...
-- CreateIndex
CREATE UNIQUE INDEX "cash_flow_entries_saleId_key" ON "cash_flow_entries"("saleId");
...
-- CreateIndex
CREATE INDEX "conversations_gymId_updatedAt_idx" ON "conversations"("gymId", "updatedAt");

-- CreateIndex
CREATE UNIQUE INDEX "conversations_gymId_phone_key" ON "conversations"("gymId", "phone");

-- CreateIndex
CREATE INDEX "messages_conversationId_createdAt_idx" ON "messages"("conversationId", "createdAt");

-- CreateIndex
CREATE INDEX "agent_actions_gymId_createdAt_idx" ON "agent_actions"("gymId", "createdAt");

-- CreateIndex
CREATE INDEX "notifications_gymId_readAt_idx" ON "notifications"("gymId", "readAt");

-- CreateIndex
CREATE INDEX "notifications_gymId_createdAt_idx" ON "notifications"("gymId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "notification_templates_key_key" ON "notification_templates"("key");

-- CreateIndex
CREATE INDEX "realtime_events_gymId_createdAt_idx" ON "realtime_events"("gymId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "realtime_events" ADD CONSTRAINT "realtime_events_gymId_fkey" FOREIGN KEY ("gymId") REFERENCES "gyms"("id") ON DELETE CASCADE ON UPDATE CASCADE;
